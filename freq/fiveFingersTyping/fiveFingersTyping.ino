...
const int Rthumb = 6;     // the number of 
const int Rindex = 5;     // the number of 
const int Rmiddle = 4;     // the number of 
const int Rring = 3;     // the number of 
const int Rpinky = 2;     // the number of 

const int LT = 7;     // the number of 
const int LI = 8;     // the number of 
const int LM = 9;     // the number of 
const int LR = 10;     // the number of 
const int LP = 11;     // the number of 
